...
__doc__ = """\
isl_preprocess_brightfield
=============
**isl_preprocess_brightfield** is an image processing module that rescales label free images.
It defines a fixed mean of 0.5 and scales the standard deviation by as set value of 0.125.
Finally, it crops values between 0 (min) and 1 (max).
|
============ ============ ===============
...
#
class isl_preprocess_brightfield(cellprofiler.module.ImageProcessing):
    #
    ...
    # by its superclass.
    #
    module_name = "isl_preprocess_brightfield"
    ...
    def create_settings(self):
        ...
        #    modules.
        super(isl_preprocess_brightfield, self).create_settings()
...
**isl_preprocess_brightfield** will do something to this image.
"""
...
"""
    ...
    def settings(self):
        ...
        #
        settings = super(isl_preprocess_brightfield, self).settings()
    ...
    def visible_settings(self):
        ...
        #
        visible_settings = super(isl_preprocess_brightfield, self).visible_settings()
    ...
    def run(self, workspace):
        ...
        super(isl_preprocess_brightfield, self).run(workspace)
...
def normalize_convert_mu_sd_cp(pixels, mean, sd):
    ...
    #I trim
    mat_ms[mat_ms > 1] = max_num
    mat_ms[mat_ms < 0] = min_num
